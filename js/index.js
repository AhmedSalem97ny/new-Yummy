...
const animation = function () {
  $(".menu")
    .animate({ width: "toggle", padding: "toggle" }, 500)
    .css("display", "flex");
  ...
  mealId.addEventListener("click", async function () {
   ...
   <div class="col-md-4 text-white">
            ...
            <div class="col-md-8 text-white">
                ...
                <h3><span class="fw-bolder">Category : </span>${meals[0].strCategory
        }</h3>
                <h3>Recipes :</h3>
                <ul class="list-unstyled d-flex g-3 flex-wrap">
                    <li class="alert alert-info m-2 p-1 ${meals[0].strIngredient1 ? "" : "d-none"}">${meals[0].strMeasure1
        } ${meals[0].strIngredient1}</li>
                    <li class="alert alert-info m-2 p-1 ${meals[0].strIngredient2 ? "" : "d-none"}">${meals[0].strMeasure2
        } ${meals[0].strIngredient2}</li>
                    <li class="alert alert-info m-2 p-1 ${meals[0].strIngredient3 ? "" : "d-none"}">${meals[0].strMeasure3
        } ${meals[0].strIngredient3}</li>
                    <li class="alert alert-info m-2 p-1 ${meals[0].strIngredient4 ? "" : "d-none"}">${meals[0].strMeasure4
        } ${meals[0].strIngredient4}</li>
                    <li class="alert alert-info m-2 p-1 ${meals[0].strIngredient5 ? "" : "d-none"}">${meals[0].strMeasure5
        } ${meals[0].strIngredient5}</li>
                    <li class="alert alert-info m-2 p-1 ${meals[0].strIngredient6 ? "" : "d-none"}">${meals[0].strMeasure6
        } ${meals[0].strIngredient6}</li>
                    <li class="alert alert-info m-2 p-1 ${meals[0].strIngredient7 ? "" : "d-none"}">${meals[0].strMeasure7
        } ${meals[0].strIngredient7}</li>
                    <li class="alert alert-info m-2 p-1 ${meals[0].strIngredient8 ? "" : "d-none"}">${meals[0].strMeasure8
        } ${meals[0].strIngredient8}</li>
                </ul>

                <h3>Tags :</h3>
                <ul class="list-unstyled d-flex g-3 flex-wrap">
                     <li class="alert alert-danger m-2 p-1 px-2">${meals[0].strTags ? meals[0].strTags : "No Tags"
        }</li>


                </ul>

                <a target="_blank" href=${meals[0].strSource
        } class="btn btn-success">Source</a>
                <a target="_blank" href=${meals[0].strYoutube
...
const searchFunction = function () {
  ...
  <div class="col-md-6 ">
  <input class="form-control bg-transparent text-white name mb-3" type="text" placeholder="Search with meal name">
  </div>
  <div class="col-md-6">
  <input maxlength="1" class="form-control bg-transparent text-white letter" type="text" placeholder="Search with meal first letter">
  </div>
  </div></div>`;
...
const errorSearch = function () {
  content.innerHTML = `
  <div class="border border-danger bg-danger border-1 py-5 px-3 w-25 text-center mx-auto invalid">
  <h2 class= "text-white">Wrong Input</h2>
  </div>
  `;
};
